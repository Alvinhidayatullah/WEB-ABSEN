  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <header>
        ...
        <p className="text-foreground/60">Pusat absensi guru dan batas area presensi SMK YASDA.</p>
      </header>
          ...
          <div className="bg-card p-6 rounded-2xl shadow-sm border border-primary/10">
            ...
            <div className="mt-6 p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl">
              <p className="text-xs text-amber-500/90 font-medium">
                ...
                Perubahan radius atau koordinat saat ini terkunci. Hubungi System Administrator untuk mengubahnya.
              </p>
            </div>
          </div>
        </div>
