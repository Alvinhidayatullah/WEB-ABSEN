      ...
      <aside className="w-full md:w-64 bg-card border-b md:border-b-0 md:border-r border-primary/10 flex flex-col p-4 md:p-6 shadow-sm z-[9999] sticky top-0 md:h-screen overflow-hidden">
        <div className="flex-1 flex flex-col gap-4 w-full">
          <div>
            ...
            <p className="hidden md:block text-[10px] text-foreground/40 mt-1 font-mono tracking-widest uppercase">Portal Kepala Sekolah</p>
          </div>
          ...
          <nav className="flex flex-row md:flex-col space-x-2 md:space-x-0 md:space-y-2 overflow-x-auto w-full pb-2 md:pb-0 scrollbar-hide">
            <Link
              href="/kepsek"
              className={`flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors whitespace-nowrap ${pathname === "/kepsek"
            ...
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors whitespace-nowrap ${pathname.startsWith("/kepsek/evaluasi")
                  ? "bg-primary/10 text-primary"
                  : "text-foreground/70 hover:bg-card-hover hover:text-primary"
                }`}
            >
